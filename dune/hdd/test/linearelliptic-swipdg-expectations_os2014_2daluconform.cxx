...
typedef SPGrid< double, 2, SPIsotropicRefinement, MPI_Comm > SPGRID;
template <bool anything>
class SWIPDGStudyExpectations< TestCases::OS2014< SPGRID >, 1, anything >
    : public internal::SWIPDGStudyExpectationsBase< TestCases::OS2014< SPGRID >, 1 >
{
  typedef TestCases::OS2014< SPGRID > TestCaseType;
...
template class SWIPDGStudyExpectations< TestCases::OS2014< SPGRID >, 1 >;
} // namespace Tests
} // namespace LinearElliptic
} // namespace HDD
} // namespace Dune
