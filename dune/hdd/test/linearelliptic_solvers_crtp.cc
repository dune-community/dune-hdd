...
#include <dune/hdd/linearelliptic/solver/interface.hh>
...
typedef testing::Types< std::pair<  Elliptic::SolverContinuousGalerkinGDT< GridPartType, RangeFieldType, dimRange, 1 >,
                                    Elliptic::SolverContinuousGalerkinGDTTraits< GridPartType, RangeFieldType, dimRange, 1 >
                                  >
