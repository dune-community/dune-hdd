...
public:
  typedef ModelDefault< DomainFieldImp, domainDim, RangeFieldImp, rangeDim, scalarDiffusion >     ThisType;
...
//  typedef typename BaseType::NeumannType    NeumannType;
  ...
  ModelDefault(/*const std::shared_ptr<*/ const DiffusionType* /*>*/ diff,
