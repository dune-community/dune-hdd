...
//      const typename DiffusionType::DomainType center = entity.geometry().center();
//      // do a piecewise constant projection of the data functions
//      //   * diffusion
//      if (diffusion()->separable())
...
//                   "\nERROR: visualize() not yet implemented for parametric but not separable data functions!");
//      //   * force
//      if (force()->separable())
