...
extern template class GenericLinearellipticMultiscaleExample< Dune::ALUGrid< 2, 2, Dune::simplex, Dune::conforming, Dune::No_Comm >,
                                                              Dune::GDT::ChooseSpaceBackend::fem,
                                                              Dune::Stuff::LA::ChooseBackend::istl_sparse >;

# if HAVE_MPI

extern template class GenericLinearellipticMultiscaleExample< Dune::ALUGrid< 2, 2, Dune::simplex, Dune::conforming, MPI_Comm >,
                                                              Dune::GDT::ChooseSpaceBackend::fem,
                                                              Dune::Stuff::LA::ChooseBackend::istl_sparse >;
