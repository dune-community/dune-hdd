...
#include <dune/detailed/solvers/stationary/linear/elliptic/fv/pdelab.hh>
...
const std::string id = "stationary.linear.elliptic.fv.pdelab";
...
int run(int argc, char** argv)
{
  try {
    ...
    ParamTreeType paramTree(argc, argv, paramFilename);
    ...
    typedef Dune::Detailed::Solvers
        ...
        ::Linear
        ::Elliptic
        ::FV::Pdelab< GridPartType, polOrder, RangeFieldType, 1 >
      SolverType;
